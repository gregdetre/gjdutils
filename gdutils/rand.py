...
def gen_readable_rand(n: int = 7, valid: Optional[list | str] = None):
...
def assert_valid_readable_rand_id(
    ...
    """
    Check if ID_ is a valid readable random id, as generated by GEN_READABLE_RAND.
    """
...
def set_seeds(seed=DEFAULT_RANDOM_SEED):
    random.seed(seed)
